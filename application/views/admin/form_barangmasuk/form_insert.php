      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <div class="form-group" style="display:inline-block;">
                <label for="harga_beli" style="width:87%;margin-left: 12px;">Harga Beli</label>
                <input type="number" name="harga_beli" style="width: 90%;margin-right: 67px;margin-left: 11px;" class="form-control" id="harga_beli" step="1.0">
            </div>
            <div class="form-group" style="display:inline-block;">
                  <label for="status_barang" style="width:73%">Status Barang</label>
                  <select class="form-control" name="status_barang" style="width:117%;margin-right: 67px;">
                    <option value="">-- Pilih --</option>
            ...
            <div class="form-group" style="display:inline-block;">
              <button type="reset" class="btn btn-basic" name="btn_reset" style="width:110%;margin-left: 60px;">
              <i class="fa fa-eraser" aria-hidden="true"></i> Reset</button>
            </div>
              <!-- /.box-body -->
