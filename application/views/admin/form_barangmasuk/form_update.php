          ...
          <div class="box box-primary" style="width:94%;">
            ...
            <?php } ?>
              ...
              <div class="form-group" style="display:inline-block; width: 15%">
                <label for="jumlah" style="width:50%;margin-left:33px;">Jumlah</label>
            ...
            <div class="form-group" style="display:inline-block;">
                <label for="harga_beli" style="width:87%;">Harga Beli</label>
                <input type="number" name="harga_beli" style="width: 90%;" class="form-control" id="harga_beli" step="1.0" value="<?=$d->harga_beli?>">
              </div>

            <div class="form-group" style="display:inline-block;">
                  <label for="status_barang" style="width:87%;margin-left: 12px;">Status Barang</label>
                  <select class="form-control" name="status_barang" style="width: 27%;margin-right: 67px;margin-left: 11px;">
                    <option value="">-- Pilih --</option>
